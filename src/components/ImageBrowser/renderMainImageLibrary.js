...
const renderMainImageLibrary = (activeTab, images, handleToggleLibraryFavourite, currentSelectedImage) => {
  ...
  const renderImages = images => images.map(image => (
    <BrowserImage
      ...
      handleToggleLibraryFavourite={handleToggleLibraryFavourite}
