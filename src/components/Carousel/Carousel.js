...
class Carousel extends React.Component {
  ...
  render() {
    ...
    const { gridSetting, imageLibrary, libraryName, currentSelectedImage, handlePreviousClick, handleNextClick } = this.props;
      ...
      <React.Fragment>
        ...
        <div className="carousel__browser-panel">
          <div
            ...
            onClick={() => handlePreviousClick(this.Carousel, libraryName)}
          >
            <CarouselButtonPrev />
          </div>
          ...
          <div
            ...
            onClick={() => handleNextClick(this.Carousel, libraryName)}
          >
            <CarouselButtonNext />
          </div>
        </div>
